 ...
 * testPolicy.allowMethod(HttpVerb.GET, "/users/username");
 * testPolicy.denyMethod(HttpVerb.POST, "/pets");
 * context.succeed(testPolicy.build());
 *
 * @class AuthPolicy
 * @constructor
 */
module.exports.AuthPolicy = class AuthPolicy {
    ...
    addMethod(effect, verb, resource, conditions) {
        if (verb !== "*" && !module.exports.HttpVerb.hasOwnProperty(verb)) {
